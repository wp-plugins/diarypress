<?php
/**
 * Custom wordpress login part of the tom Howson Diary system
 *
...
<head>
	...
	<link rel="EditURI" type="application/rsd+xml" title="RSD" href="https://www.howson.me.uk/xmlrpc.php?rsd" />
<link rel="wlwmanifest" type="application/wlwmanifest+xml" href="https://www.howson.me.uk/wp-includes/wlwmanifest.xml" /> 

</head>
<body class="login">

<div id="login"><h1><a href="<?php echo apply_filters('login_headerurl', 'http://www.howson.me.uk/'); ?>" title="<?php echo apply_filters('login_headertitle', __('Powered by WordPress & Howson Diary System')); ?>"><?php bloginfo('name'); ?></a></h1>
<?php
	...
	<p class="message">This blog is protected, please log in.</p>
<?php
	} // End of login_header()
